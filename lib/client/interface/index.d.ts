...
interface Authenticable {
    authenticate(...args: any[]): Promise<Result<Authentication>>;
...
export interface FinancialClientModule extends Signable<FinancialClientModule> {
    ...
    removeFile(commercialDealFileId: number, token?: string): any;
    downloadCommercialDealFile(commercialDealFileId: number, token?: string): any;
}
export {};
