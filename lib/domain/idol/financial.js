...
const charity_institution_1 = require("./charity-institution");
const groups_1 = require("../../utils/validators/groups");
class IdolFinancial {
    constructor() {
        this.include = false;
        this.charityInstitution = new charity_institution_1.CharityInstitution();
        this.charityPercentage = "ONE";
    }
}
__decorate([
...
], IdolFinancial.prototype, "id", void 0);
__decorate([
    ...
    __metadata("design:type", charity_institution_1.CharityInstitution)
], IdolFinancial.prototype, "charityInstitution", void 0);
__decorate([
    class_validator_1.IsNotEmpty({ message: values_1.Violation.MANDATORY_FIELD, always: true }),
    __metadata("design:type", String)
], IdolFinancial.prototype, "charityPercentage", void 0);
exports.IdolFinancial = IdolFinancial;
